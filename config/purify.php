    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,small,sub,sup,pre[class],code[class],a[href|title|target|rel|class],ul,ol,li,p[style|class],br,hr,span[style|class],img[width|height|alt|src|style|class],blockquote[class|lang|dir|cite],div[class|style|id],section[class],article[class],figure[class],figcaption[class],table[class],thead[class],tbody[class],tfoot[class],tr[class],th[class|colspan|rowspan],td[colspan|rowspan|class],script[src|async|defer|charset|type|crossorigin],iframe[src|width|height|title|allow|allowfullscreen|frameborder|loading|referrerpolicy|name|class]',

            /*
             * Admin-authored content is trusted: allow third-party embed
             * vehicles (script loaders, iframes, object/embed). iframe src
             * is additionally gated to https by URI.SafeIframeRegexp below.
             */
            'HTML.Trusted' => true,
