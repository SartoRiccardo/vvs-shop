            ...
            <div>
                ...
                <div v-if="! isLoading">
                    <div class="flex items-center justify-between max-md:px-4">
                        ...
                        <div
                            class="secondary-button flex items-center gap-x-2.5 whitespace-nowrap border-divider px-5 py-3 font-normal max-md:rounded-lg max-md:px-3 max-md:text-xs max-sm:py-1.5"
                            v-if="items.length"
                            @click="removeAll"
                        >
                    ...
                    >
                        <template v-for="attribute in comparableAttributes">
                            <!-- Product Card -->
                            <div
                                class="flex max-w-full items-center border-b border-divider"
                            ...
                            >
                                ...
                                <div class="flex gap-3 border-divider max-md:gap-0 max-md:border-0 ltr:border-l-[1px] rtl:border-r-[1px]">
                                    <div
                                        class="relative w-[311px] max-w-[311px] px-5 max-md:w-60 max-md:px-2.5 max-sm:w-[190px]"
                                        v-for="product in items"
                                    >
                                        <span
                                            class="icon-cancel absolute top-5 z-[1] flex h-[30px] w-[30px] cursor-pointer items-center justify-center rounded-md border border-divider bg-pageBg text-2xl max-md:top-10 max-md:h-6 max-md:w-6 max-md:rounded-full max-md:text-sm ltr:right-10 max-md:ltr:right-4 rtl:left-10 max-md:rtl:left-4"
