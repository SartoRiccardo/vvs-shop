...
>
    ...
    @isset($header)
        <template v-slot:header="{ close }">
            <div {{ $header->attributes->merge(['class' => 'grid gap-y-2.5 p-6 pb-5 max-md:gap-y-1.5 max-md:border-b max-md:border-divider max-md:p-4 max-md:gap-y-1 max-md:font-semibold']) }}>
                {{ $header }}
...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="fixed z-[1000] overflow-hidden bg-pageBg max-md:!w-full"
                    :class="{
                    ...
                    v-show="isOpen"
                >
                    <div class="pointer-events-auto h-full w-full overflow-auto bg-pageBg">
