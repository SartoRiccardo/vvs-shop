                ...
                >
                    ...
                    <template v-if="! attribute.swatch_type || attribute.swatch_type == '' || attribute.swatch_type == 'dropdown'">
                        ...
                        <v-field
                            ...
                            class="custom-select mb-3 block w-full cursor-pointer rounded-lg border border-divider bg-pageBg px-5 py-3 text-base text-mutedText focus:border-blue-500 focus:ring-blue-500"
                        ...
                        <div class="flex items-center gap-3">
                            <template v-for="(option, index) in attribute.options">
                                <template v-if="option.id">
                                    ...
                                    <label 
                                        class="group relative flex h-[60px] w-[60px] cursor-pointer items-center justify-center overflow-hidden rounded-md border bg-pageBg font-medium uppercase text-gray-900 hover:bg-gray-50 sm:py-6"
                                    ...
                                    <!-- Text Swatch Options -->
                                    <label 
                                        class="group relative flex h-fit min-w-fit cursor-pointer items-center justify-center rounded-full border border-gray-300 bg-pageBg px-5 py-3 font-medium uppercase text-gray-900 hover:bg-gray-50 max-sm:h-fit max-sm:w-fit max-sm:px-3.5 max-sm:py-2"
