@if ($product->type == 'bundle')
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mt-8 border-b border-divider pb-4 max-sm:mt-4 max-sm:pb-0">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span class="text-mutedText line-through max-sm:text-sm">
                    ...
                    <template v-if="option.type == 'radio'">
                        <div class="grid gap-2 max-sm:gap-1">
                            ...
                            >
                                ...
                                <label
                                    class="cursor-pointer text-mutedText max-sm:text-sm"
                                    :for="'bundle_options[' + option.id + '][' + index + ']'"
                                >
                                    @lang('shop::app.products.view.type.bundle.none')
                                </label>
                            ...
                            >
                                ...
                                <label
                                    class="flex cursor-pointer gap-2 text-mutedText max-sm:text-sm"
                                    :for="'bundle_options[' + option.id + '][' + index + ']'"
                                >
                                    @{{ product.name }}
                ...
                <template v-if="['select', 'radio'].includes(option.type)">
                    <x-shop::quantity-changer
                        ...
                        ::value="productQty"
                        class="mt-5 w-max gap-x-4 rounded-xl !border-divider px-4 py-1.5 max-sm:my-4"
