                ...
                >
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-2 grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-md:mt-2 max-md:grid-cols-1">
                            <div
                                class="relative max-w-[414px] cursor-pointer select-none rounded-xl border border-divider p-0 max-md:flex-wrap max-md:rounded-lg"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p class="mt-6 text-sm text-mutedText max-md:mt-2 max-sm:mt-0">
                            ...
                            <!-- New Address Card -->
                            <div
                                class="flex max-w-[414px] cursor-pointer items-center justify-center rounded-xl border border-divider p-5 max-md:flex-wrap max-md:rounded-lg"
                        ...
                        <template v-if="cart.have_stockable_items">
                            ...
                            <x-shop::form.control-group class="!mb-0 mt-5 flex items-center gap-2.5">
                                ...
                                <label
                                    class="cursor-pointer select-none text-base text-mutedText max-md:text-sm max-sm:text-xs ltr:pl-0 rtl:pr-0"
                                    for="use_for_shipping"
                                >
