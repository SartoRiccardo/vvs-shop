...
return [
    ...
    [
        ...
        'key' => 'general.content.social_links',
        'name' => 'admin::app.configuration.index.general.content.social-links.title',
        'info' => 'admin::app.configuration.index.general.content.social-links.info',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'youtube',
                'title' => 'admin::app.configuration.index.general.content.social-links.youtube',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => false,
            ], [
                'name' => 'facebook',
                'title' => 'admin::app.configuration.index.general.content.social-links.facebook',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => false,
            ], [
                'name' => 'twitter',
                'title' => 'admin::app.configuration.index.general.content.social-links.twitter',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => false,
            ], [
                'name' => 'tiktok',
                'title' => 'admin::app.configuration.index.general.content.social-links.tiktok',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => false,
            ], [
                'name' => 'instagram',
                'title' => 'admin::app.configuration.index.general.content.social-links.instagram',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => false,
            ],
        ...
        'name' => 'admin::app.configuration.index.general.design.theme-colors.title',
        'info' => 'admin::app.configuration.index.general.design.theme-colors.title-info',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'primary',
                'title' => 'admin::app.configuration.index.general.design.theme-colors.primary',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.primary-info',
                'type' => 'color',
                'default' => '#060c3b',
                'channel_based' => false,
                'locale_based' => false,
                ...
                'name' => 'background',
                'title' => 'admin::app.configuration.index.general.design.theme-colors.background',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.background-info',
                'type' => 'color',
                'default' => '#f6f2eb',
                'channel_based' => false,
                'locale_based' => false,
                ...
                'name' => 'link',
                'title' => 'admin::app.configuration.index.general.design.theme-colors.link',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.link-info',
                'type' => 'color',
                'default' => '#0044f2',
                'channel_based' => false,
                'locale_based' => false,
                ...
                'name' => 'success',
                'title' => 'admin::app.configuration.index.general.design.theme-colors.success',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.success-info',
                'type' => 'color',
                'default' => '#40994a',
                'channel_based' => false,
                'locale_based' => false,
                ...
                'name' => 'danger',
                'title' => 'admin::app.configuration.index.general.design.theme-colors.danger',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.danger-info',
                'type' => 'color',
                'default' => '#f85156',
                'channel_based' => false,
                'locale_based' => false,
                ...
                'title' => 'admin::app.configuration.index.general.design.theme-colors.page-background',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.page-background-info',
                'type' => 'color',
                'default' => '#ffffff',
                'channel_based' => false,
                'locale_based' => false,
                ...
                'name' => 'neutral',
                'title' => 'admin::app.configuration.index.general.design.theme-colors.neutral',
                'info' => 'admin::app.configuration.index.general.design.theme-colors.neutral-info',
                'type' => 'color',
                'default' => '#71717a',
                'channel_based' => false,
                'locale_based' => false,
    ...
    [
        ...
        'fields' => [
            [
                ...
                'name' => 'page_title',
                'title' => 'admin::app.configuration.index.customer.settings.newsletter.page-title',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => true,
            ], [
                'name' => 'page_subtitle',
                'title' => 'admin::app.configuration.index.customer.settings.newsletter.page-subtitle',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => true,
            ], [
                'name' => 'page_meta_title',
                'title' => 'admin::app.configuration.index.customer.settings.newsletter.page-meta-title',
                'type' => 'text',
                'channel_based' => false,
                'locale_based' => true,
            ], [
                'name' => 'page_meta_description',
                'title' => 'admin::app.configuration.index.customer.settings.newsletter.page-meta-description',
                'type' => 'textarea',
                'channel_based' => false,
                'locale_based' => true,
            ], [
                'name' => 'page_meta_keywords',
                'title' => 'admin::app.configuration.index.customer.settings.newsletter.page-meta-keywords',
                'type' => 'textarea',
                'channel_based' => false,
                'locale_based' => true,
            ], [
                ...
                'info' => 'admin::app.configuration.index.customer.settings.newsletter.page-content-before-info',
                'type' => 'textarea',
                'channel_based' => false,
                'locale_based' => true,
            ], [
                'name' => 'page_content_after',
                'title' => 'admin::app.configuration.index.customer.settings.newsletter.page-content-after',
                'info' => 'admin::app.configuration.index.customer.settings.newsletter.page-content-after-info',
                'type' => 'textarea',
                'channel_based' => false,
                'locale_based' => true,
            ],
