            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'social-links' => [
                        ...
                        'info' => 'قم بتكوين روابط وسائل التواصل الاجتماعي المعروضة في تذييل موقعك.',
                        'youtube' => 'رابط يوتيوب',
                        'facebook' => 'رابط فيسبوك',
                        'twitter' => 'رابط X (تويتر)',
                        'tiktok' => 'رابط تيك توك',
                        'instagram' => 'رابط إنستغرام',
                    ],

                    'error-404' => [
                        'title' => 'محتوى صفحة 404',
                        'info' => 'قم بتعيين محتوى مخصص لصفحة الخطأ 404 المعروضة في المتجر.',
                        'content-title' => 'محتوى صفحة 404',
                        'content-info' => 'HTML مخصص يظهر في منتصف صفحة 404. اتركه فارغا لعرض الرسالة الافتراضية.',
                    ],
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        ...
                        'background-info' => 'تُستخدم لخلفية التذييل، بما في ذلك مربع النشرة الإخبارية وشريط حقوق النشر.',
                        'danger' => 'لون الخطر',
                        'danger-info' => 'لم تُطبَّق بعد على أي عنصر في واجهة المتجر — محجوزة للاستخدام المستقبلي (مثل حالات الخطأ وشارات نفاد المخزون).',
                        'link' => 'لون الرابط',
                        'link-info' => 'لم تُطبَّق بعد على أي عنصر في واجهة المتجر — محجوزة للاستخدام المستقبلي.',
                        'neutral' => 'محايد',
                        'neutral-info' => 'يحل محل لون النص الثانوي/الخافت في الموقع (المبلغ المشطوب في الأسعار، الطوابع الزمنية، التسميات التوضيحية، عدد المراجعات). يتم اشتقاق حدود البطاقات/الفواصل/الجداول الافتراضية وخلفيات هيكل التحميل الفاتحة تلقائيًا من نفس هذا اللون عن طريق مزجه باللون الأبيض، بحيث تتحكم عينة لون واحدة في عائلة الرمادي المحايد بأكملها.',
                        'page-background' => 'خلفية الصفحة',
                        'page-background-info' => 'تُستخدم لخلفية الموقع بأكمله — الجسم والترويسة وحاوية المحتوى الرئيسي ومعظم أسطح البطاقات والنوافذ المنبثقة وحقول الإدخال.',
                        'primary' => 'اللون الأساسي',
                        'primary-info' => 'تُستخدم للأزرار والروابط والحالات النشطة ومربعات الاختيار/أزرار الاختيار والدرجات الخفيفة مثل خط الفاصل في الترويسة وحالة التحويم لزر الإجراء الثانوي.',
                        'success' => 'لون النجاح',
                        'success-info' => 'لم تُطبَّق بعد على أي عنصر في واجهة المتجر — محجوزة للاستخدام المستقبلي (مثل لافتات النجاح وشارات توفر المخزون).',
                        'title' => 'ألوان السمة',
                        'title-info' => 'حدد ألوان العلامة التجارية للواجهة الأمامية للمتجر. تُطبَّق التغييرات فورًا دون الحاجة إلى إعادة بناء الأصول.',
                    ],
                ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'newsletter' => [
                        ...
                        'footer-title' => 'عنوان النشرة الإخبارية في التذييل',
                        'footer-subtitle' => 'العنوان الفرعي للنشرة الإخبارية في التذييل',
                        'page-title' => 'عنوان صفحة النشرة البريدية',
                        'page-subtitle' => 'العنوان الفرعي لصفحة النشرة البريدية',
                        'page-meta-title' => 'الميتا عنوان لصفحة النشرة البريدية',
                        'page-meta-description' => 'الميتا وصف لصفحة النشرة البريدية',
                        'page-meta-keywords' => 'الميتا كلمات مفتاحية لصفحة النشرة البريدية',
                        'page-content-before' => 'محتوى صفحة النشرة البريدية (قبل النموذج)',
                        'page-content-after' => 'محتوى صفحة النشرة البريدية (بعد النموذج)',
                        'page-content-before-info' => 'محتوى HTML مخصص يُعرض أعلى نموذج الاشتراك في صفحة النشرة البريدية.',
                        'page-content-after-info' => 'محتوى HTML مخصص يُعرض أسفل نموذج الاشتراك في صفحة النشرة البريدية.',
                    ],
