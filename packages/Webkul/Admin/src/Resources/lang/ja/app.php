        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'error-404' => [
                        'title' => '404ページのコンテンツ',
                        'info' => 'ストアに表示される404エラーページのカスタムコンテンツを設定します。',
                        'content-title' => '404ページのコンテンツ',
                        'content-info' => '404ページの中央に表示されるカスタムHTML。空のままにするとデフォルトのメッセージが表示されます。',
                    ],
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        'background' => '背景色',
                        'background-info' => 'フッターの背景（ニュースレターボックスやコピーライトバーを含む）に使用されます。',
                        'danger' => '危険色',
                        'danger-info' => 'まだどのストアフロント要素にも適用されていません — 将来の使用のために予約されています（例: エラー状態、在庫切れバッジ）。',
                        'link' => 'リンクの色',
                        'link-info' => 'まだどのストアフロント要素にも適用されていません — 将来の使用のために予約されています。',
                        'neutral' => 'ニュートラル',
                        'neutral-info' => 'サイトのミュート/セカンダリテキストの色（価格の取り消し線部分、タイムスタンプ、キャプション、レビュー数）を置き換えます。デフォルトのカード/区切り線/テーブルのボーダーと明るいスケルトンローダーの背景は、この色を白と混合することで自動的に導出されるため、1つのスウォッチでニュートラルグレー系統全体を制御します。',
                        'page-background' => 'ページの背景色',
                        'page-background-info' => 'サイトのキャンバス（ボディ、ヘッダー、メインコンテンツラッパー、およびほとんどのカード、モーダル、入力欄の表面）に使用されます。',
                        'primary' => 'プライマリカラー',
                        'primary-info' => 'ボタン、リンク、アクティブ状態、チェックボックス/ラジオボタン、およびヘッダーの区切り線やセカンダリボタンのホバー状態などの微妙な色合いに使用されます。',
                        'success' => '成功色',
                        'success-info' => 'まだどのストアフロント要素にも適用されていません — 将来の使用のために予約されています（例: 成功バナー、在庫ありバッジ）。',
                        'title' => 'テーマカラー',
                        'title-info' => 'ストアフロントのブランドカラーを設定します。変更はアセットを再構築せずに即座に反映されます。',
                    ],
                ],
