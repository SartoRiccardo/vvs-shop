            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'social-links' => [
                        ...
                        'info' => 'لینک‌های شبکه‌های اجتماعی نمایش داده شده در پاورقی وب‌سایت خود را پیکربندی کنید.',
                        'youtube' => 'لینک یوتیوب',
                        'facebook' => 'لینک فیسبوک',
                        'twitter' => 'لینک X (توییتر)',
                        'tiktok' => 'لینک تیک‌تاک',
                    ...
                    'error-404' => [
                        ...
                        'info' => 'محتوای سفارشی صفحه خطای 404 نمایش داده شده در فروشگاه را تنظیم کنید.',
                        'content-title' => 'محتوای صفحه 404',
                        'content-info' => 'HTML سفارشی که در وسط صفحه 404 نمایش داده می‌شود. برای نمایش پیام پیش‌فرض خالی بگذارید.',
                    ],
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        ...
                        'background-info' => 'برای پس‌زمینه پاورقی، از جمله جعبه خبرنامه و نوار کپی‌رایت آن استفاده می‌شود.',
                        'danger' => 'رنگ خطر',
                        'danger-info' => 'هنوز به هیچ عنصری در فروشگاه اعمال نشده — برای استفاده‌های آینده رزرو شده است (مانند حالت‌های خطا، برچسب‌های ناموجود بودن کالا).',
                        'link' => 'رنگ پیوند',
                        'link-info' => 'هنوز به هیچ عنصری در فروشگاه اعمال نشده — برای استفاده‌های آینده رزرو شده است.',
                        'neutral' => 'خنثی',
                        'neutral-info' => 'رنگ متن ثانویه/کم‌رنگ سایت (مبلغ خط‌خورده قیمت‌ها، برچسب‌های زمانی، توضیحات کوتاه، تعداد نظرات) را جایگزین می‌کند. حاشیه پیش‌فرض کارت‌ها/جداکننده‌ها/جدول و پس‌زمینه‌های روشن اسکلت بارگذاری به‌طور خودکار از همین رنگ با ترکیب آن با سفید به دست می‌آیند، بنابراین یک نمونه رنگ کل خانواده خاکستری خنثی را کنترل می‌کند.',
                        'page-background' => 'پس‌زمینه صفحه',
                        'page-background-info' => 'برای بوم سایت استفاده می‌شود — بدنه، هدر، بسته‌بندی محتوای اصلی، و اکثر سطوح کارت‌ها، پنجره‌های مودال و ورودی‌ها.',
                        'primary' => 'رنگ اصلی',
                        'primary-info' => 'برای دکمه‌ها، پیوندها، حالت‌های فعال، چک‌باکس‌ها/دکمه‌های رادیویی و سایه‌های ظریف مانند خط جداکننده هدر و حالت هاور دکمه ثانویه استفاده می‌شود.',
                        'success' => 'رنگ موفقیت',
                        'success-info' => 'هنوز به هیچ عنصری در فروشگاه اعمال نشده — برای استفاده‌های آینده رزرو شده است (مانند بنرهای موفقیت، برچسب‌های موجود بودن کالا).',
                        'title' => 'رنگ‌های قالب',
                        'title-info' => 'رنگ‌های برند فروشگاه را تنظیم کنید. تغییرات بدون نیاز به بازسازی دارایی‌ها فوراً اعمال می‌شوند.',
                    ],
                ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'newsletter' => [
                        ...
                        'footer-title' => 'عنوان خبرنامه در فوتر',
                        'footer-subtitle' => 'زیرعنوان خبرنامه در فوتر',
                        'page-title' => 'عنوان صفحه خبرنامه',
                        'page-subtitle' => 'زیرعنوان صفحه خبرنامه',
                        'page-meta-title' => 'متا عنوان صفحه خبرنامه',
                        'page-meta-description' => 'متا توضیحات صفحه خبرنامه',
                        'page-meta-keywords' => 'متا کلمات کلیدی صفحه خبرنامه',
                        'page-content-before' => 'محتوای صفحه خبرنامه (قبل از فرم)',
                        'page-content-after' => 'محتوای صفحه خبرنامه (بعد از فرم)',
                        'page-content-before-info' => 'محتوای HTML سفارشی که بالای فرم اشتراک در صفحه خبرنامه نمایش داده می‌شود.',
                        'page-content-after-info' => 'محتوای HTML سفارشی که زیر فرم اشتراک در صفحه خبرنامه نمایش داده می‌شود.',
                    ],
