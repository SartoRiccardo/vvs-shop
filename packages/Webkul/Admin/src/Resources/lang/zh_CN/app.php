        ...
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        'background' => '背景颜色',
                        'background-info' => '用于页脚背景，包括其订阅框和版权栏。',
                        'danger' => '危险颜色',
                        'danger-info' => '尚未应用于任何店面元素——预留供将来使用（例如错误状态、缺货标记）。',
                        'link' => '链接颜色',
                        'link-info' => '尚未应用于任何店面元素——预留供将来使用。',
                        'neutral' => '中性色',
                        'neutral-info' => '替代网站的弱化/次要文本颜色（价格的删除线金额、时间戳、说明文字、评论数量）。默认的卡片/分隔线/表格边框以及浅色骨架加载器背景会通过将此颜色与白色混合自动生成，因此一个色板即可控制整个中性灰色系统。',
                        'page-background' => '页面背景',
                        'page-background-info' => '用于站点画布——页面主体、页眉、主内容包装器，以及大多数卡片、模态框和输入框表面。',
                        'primary' => '主色',
                        'primary-info' => '用于按钮、链接、激活状态、复选框/单选框，以及页眉分隔线和次要按钮悬停状态等细微色调。',
                        'success' => '成功颜色',
                        'success-info' => '尚未应用于任何店面元素——预留供将来使用（例如成功横幅、有货标记）。',
                        'title' => '主题颜色',
                        'title-info' => '设置店面的品牌颜色。更改会立即生效，无需重新构建资源。',
                    ],
                ],
