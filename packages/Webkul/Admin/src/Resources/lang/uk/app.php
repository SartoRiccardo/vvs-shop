            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'social-links' => [
                        ...
                        'info' => 'Налаштуйте посилання на соціальні мережі, що відображаються у нижньому колонтитулі вашого сайту.',
                        'youtube' => 'URL-адреса YouTube',
                        'facebook' => 'URL-адреса Facebook',
                        'twitter' => 'URL-адреса X (Twitter)',
                        'tiktok' => 'URL-адреса TikTok',
                        'instagram' => 'URL-адреса Instagram',
                    ],

                    'error-404' => [
                        'title' => 'Вміст сторінки 404',
                        'info' => 'Налаштуйте власний вміст сторінки помилки 404, що відображається в магазині.',
                        'content-title' => 'Вміст сторінки 404',
                        'content-info' => 'Власний HTML, що відображається по центру сторінки 404. Залиште порожнім, щоб показати стандартне повідомлення.',
                    ],
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        ...
                        'background-info' => 'Використовується для фону підвалу, включно з блоком розсилки та рядком авторських прав.',
                        'danger' => 'Колір небезпеки',
                        'danger-info' => 'Ще не застосовано до жодного елемента вітрини — зарезервовано для використання в майбутньому (наприклад, стани помилок, значки "немає в наявності").',
                        'link' => 'Колір посилань',
                        'link-info' => 'Ще не застосовано до жодного елемента вітрини — зарезервовано для використання в майбутньому.',
                        'neutral' => 'Нейтральний',
                        'neutral-info' => 'Замінює приглушений/вторинний колір тексту сайту (закреслена сума ціни, часові мітки, підписи, кількість відгуків). Стандартна межа карток/роздільників/таблиць і фон світлого скелетного завантажувача автоматично формуються з цього ж кольору шляхом змішування з білим, тому один зразок керує всією нейтрально-сірою палітрою.',
                        'page-background' => 'Фон сторінки',
                        'page-background-info' => 'Використовується для полотна сайту — тіла сторінки, шапки, обгортки основного вмісту та більшості поверхонь карток, модальних вікон і полів введення.',
                        'primary' => 'Основний колір',
                        'primary-info' => 'Використовується для кнопок, посилань, активних станів, прапорців/перемикачів і тонких відтінків, як-от роздільна лінія в шапці та стан наведення на вторинну кнопку.',
                        'success' => 'Колір успіху',
                        'success-info' => 'Ще не застосовано до жодного елемента вітрини — зарезервовано для використання в майбутньому (наприклад, банери успіху, значки "в наявності").',
                        'title' => 'Кольори теми',
                        'title-info' => 'Налаштуйте фірмові кольори вітрини магазину. Зміни застосовуються негайно, без повторної збірки ресурсів.',
                    ],
                ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'newsletter' => [
                        ...
                        'footer-title' => 'Заголовок розсилки в підвалі',
                        'footer-subtitle' => 'Підзаголовок розсилки в підвалі',
                        'page-title' => 'Заголовок сторінки розсилки',
                        'page-subtitle' => 'Підзаголовок сторінки розсилки',
                        'page-meta-title' => 'Мета-заголовок сторінки розсилки',
                        'page-meta-description' => 'Мета-опис сторінки розсилки',
                        'page-meta-keywords' => 'Мета-ключові слова сторінки розсилки',
                        'page-content-before' => 'Вміст сторінки розсилки (перед формою)',
                        'page-content-after' => 'Вміст сторінки розсилки (після форми)',
                        'page-content-before-info' => 'Користувацький HTML-вміст, що відображається над формою підписки на сторінці розсилки.',
                        'page-content-after-info' => 'Користувацький HTML-вміст, що відображається під формою підписки на сторінці розсилки.',
                    ],
