            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'social-links' => [
                        ...
                        'info' => 'הגדר את קישורי הרשתות החברתיות המוצגים בתחתית האתר שלך.',
                        'youtube' => 'קישור ליוטיוב',
                        'facebook' => 'קישור לפייסבוק',
                        'twitter' => 'קישור ל-X (טוויטר)',
                    ...
                    'error-404' => [
                        'title' => 'תוכן דף 404',
                        'info' => 'הגדרת תוכן מותאם אישית לדף השגיאה 404 המוצג בחנות.',
                        'content-title' => 'תוכן דף 404',
                        'content-info' => 'HTML מותאם אישית המוצג במרכז דף ה-404. יש להשאיר ריק להצגת ההודעה המוגדרת כברירת מחדל.',
                    ],
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        'background' => 'צבע רקע',
                        'background-info' => 'משמש לרקע הכותרת התחתונה, כולל תיבת הניוזלטר שלה ופס זכויות היוצרים.',
                        'danger' => 'צבע סכנה',
                        'danger-info' => 'טרם הוחל על אף רכיב בחזית החנות — שמור לשימוש עתידי (למשל מצבי שגיאה, תגי אזל מהמלאי).',
                        'link' => 'צבע קישור',
                        'link-info' => 'טרם הוחל על אף רכיב בחזית החנות — שמור לשימוש עתידי.',
                        'neutral' => 'ניטרלי',
                        'neutral-info' => 'מחליף את צבע הטקסט המשני/המושתק של האתר (הסכום המחוק במחירים, חותמות זמן, כיתובים, מספר ביקורות). גבול ברירת המחדל של כרטיסים/קווים מפרידים/טבלאות ורקעי טעינת השלד הבהירים נגזרים אוטומטית מאותו הצבע על ידי מיזוגו עם לבן, כך שגוון אחד שולט על כל משפחת האפור הניטרלי.',
                        'page-background' => 'רקע העמוד',
                        'page-background-info' => 'משמש עבור בד האתר — גוף העמוד, הכותרת העליונה, מעטפת התוכן הראשי, ורוב משטחי הכרטיסים, החלונות הקופצים ושדות הקלט.',
                        'primary' => 'צבע ראשי',
                        'primary-info' => 'משמש עבור כפתורים, קישורים, מצבים פעילים, תיבות סימון/כפתורי רדיו, וגוונים עדינים כמו קו המפריד בכותרת העליונה ומצב הריחוף של הכפתור המשני.',
                        'success' => 'צבע הצלחה',
                        'success-info' => 'טרם הוחל על אף רכיב בחזית החנות — שמור לשימוש עתידי (למשל, באנרים של הצלחה, תגי במלאי).',
                        'title' => 'צבעי ערכת נושא',
                        'title-info' => 'הגדר את צבעי המותג של החזית. השינויים חלים באופן מיידי ללא צורך בבנייה מחדש של הנכסים.',
                    ],
                ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'newsletter' => [
                        ...
                        'footer-title' => 'כותרת הניוזלטר בכותרת התחתונה',
                        'footer-subtitle' => 'כותרת משנה לניוזלטר בכותרת התחתונה',
                        'page-title' => 'כותרת עמוד הניוזלטר',
                        'page-subtitle' => 'כותרת משנה של עמוד הניוזלטר',
                        'page-meta-title' => 'מטא כותרת של עמוד הניוזלטר',
                        'page-meta-description' => 'מטא תיאור של עמוד הניוזלטר',
                        'page-meta-keywords' => 'מטא מילות מפתח של עמוד הניוזלטר',
                        'page-content-before' => 'תוכן עמוד הניוזלטר (לפני הטופס)',
                        'page-content-after' => 'תוכן עמוד הניוזלטר (אחרי הטופס)',
                        'page-content-before-info' => 'תוכן HTML מותאם אישית המוצג מעל טופס ההרשמה בעמוד הניוזלטר.',
                        'page-content-after-info' => 'תוכן HTML מותאם אישית המוצג מתחת לטופס ההרשמה בעמוד הניוזלטר.',
                    ],
