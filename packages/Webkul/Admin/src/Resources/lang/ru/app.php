            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'social-links' => [
                        ...
                        'info' => 'Настройте ссылки на социальные сети, отображаемые в подвале вашего сайта.',
                        'youtube' => 'URL YouTube',
                    ...
                    'error-404' => [
                        'title' => 'Содержимое страницы 404',
                        'info' => 'Задайте пользовательское содержимое для страницы ошибки 404, отображаемой в магазине.',
                        'content-title' => 'Содержимое страницы 404',
                        'content-info' => 'Пользовательский HTML, отображаемый по центру страницы 404. Оставьте пустым, чтобы показать сообщение по умолчанию.',
                    ],
                ...
                'design' => [
                    ...
                    'theme-colors' => [
                        ...
                        'background-info' => 'Используется для фона подвала, включая блок рассылки и строку авторских прав.',
                        'danger' => 'Цвет опасности',
                        'danger-info' => 'Пока не применяется ни к одному элементу витрины — зарезервировано для использования в будущем (например, состояния ошибок, значки "нет в наличии").',
                        'link' => 'Цвет ссылок',
                        'link-info' => 'Пока не применяется ни к одному элементу витрины — зарезервировано для использования в будущем.',
                        'neutral' => 'Нейтральный',
                        'neutral-info' => 'Заменяет приглушённый/вторичный цвет текста сайта (зачёркнутая сумма цены, временные метки, подписи, количество отзывов). Стандартная граница карточек/разделителей/таблиц и фон светлого скелетного загрузчика автоматически формируются из этого же цвета путём смешивания с белым, поэтому один образец управляет всей нейтрально-серой палитрой.',
                        'page-background' => 'Фон страницы',
                        'page-background-info' => 'Используется для холста сайта — тела страницы, шапки, обёртки основного контента и большинства поверхностей карточек, модальных окон и полей ввода.',
                        'primary' => 'Основной цвет',
                        'primary-info' => 'Используется для кнопок, ссылок, активных состояний, флажков/переключателей и тонких оттенков, таких как разделительная линия в шапке и состояние наведения на вторичную кнопку.',
                        'success' => 'Цвет успеха',
                        'success-info' => 'Пока не применяется ни к одному элементу витрины — зарезервировано для использования в будущем (например, баннеры успеха, значки "в наличии").',
                        'title' => 'Цвета темы',
                        'title-info' => 'Настройте фирменные цвета витрины магазина. Изменения применяются немедленно, без пересборки ресурсов.',
                    ],
                ],
            ...
            'customer' => [
                ...
                'settings' => [
                    ...
                    'newsletter' => [
                        ...
                        'footer-title' => 'Заголовок рассылки в подвале',
                        'footer-subtitle' => 'Подзаголовок рассылки в подвале',
                        'page-title' => 'Заголовок страницы рассылки',
                        'page-subtitle' => 'Подзаголовок страницы рассылки',
                        'page-meta-title' => 'Мета-заголовок страницы рассылки',
                        'page-meta-description' => 'Мета-описание страницы рассылки',
                        'page-meta-keywords' => 'Мета-ключевые слова страницы рассылки',
                        'page-content-before' => 'Содержимое страницы рассылки (перед формой)',
                        'page-content-after' => 'Содержимое страницы рассылки (после формы)',
                        'page-content-before-info' => 'Пользовательский HTML-контент, отображаемый над формой подписки на странице рассылки.',
                        'page-content-after-info' => 'Пользовательский HTML-контент, отображаемый под формой подписки на странице рассылки.',
                    ],
