            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-md:w-full">
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <!-- Customer Group -->
                        <div id="customer-group-field" class="{{ old('filter_by_tags') ? 'hidden' : '' }}">
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                        ...
                        <div id="tag-filter-section" class="{{ old('filter_by_tags') ? '' : 'hidden' }} mb-4">
                            ...
                            @else
                                <v-campaign-tag-filter
                                    ...
                                    :initial-selected="{{ json_encode(array_map('intval', old('subscriber_tag_ids', []))) }}"
                                />
                            @endif
                        </div>
