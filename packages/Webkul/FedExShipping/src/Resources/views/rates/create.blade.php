    ...
    <div class="mt-6 max-w-sm rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <form action="{{ route('fedex.zones.rates.store', $zoneCode) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" name="weight_max" value="{{ old('weight_max') }}" step="0.5" min="0.5"
                ...
                <p class="mt-1 text-xs text-gray-400">Leave blank to create an open-ended tail row.</p>
            ...
            <div>
                ...
                <input type="number" name="flat_rate" value="{{ old('flat_rate') }}" step="0.01" min="0" required
                    class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-800 dark:text-white" />
            ...
            <div>
                ...
                <input type="number" name="per_kg_rate" value="{{ old('per_kg_rate') }}" step="0.0001" min="0" required
                    class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-800 dark:text-white" />
